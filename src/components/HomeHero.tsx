  ...
  return (
    <section className="relative w-full min-h-[85vh] lg:min-h-[90vh] flex items-center overflow-hidden border-b border-[#EAE5DD]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#F6F2EA] via-[#F6F2EA]/85 md:via-[#F6F2EA]/65 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#F6F2EA] via-transparent to-transparent opacity-80" />
      </div>
